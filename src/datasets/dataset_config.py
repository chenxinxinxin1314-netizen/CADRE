...
_DEFAULT_DATA_PATH = os.path.abspath(join(os.path.dirname(__file__), '..', '..', 'data'))
_BASE_DATA_PATH = os.path.expanduser(os.environ.get('CADRE_DATA_ROOT', _DEFAULT_DATA_PATH))
...
dataset_config = {
    ...
    'imagenet_256': {
        'path': join(_BASE_DATA_PATH, 'imagenet_subset'),
        'resize': None,
        'crop': 224,
        'flip': True,
        'normalize': ((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))
